...
export const researchDesigns: ResearchDesign[] = [
  ...
  },
  {
    ...
    category: 'qualitative',
    description: 'Develops theory from data through systematic collection and analysis. Theory emerges from the data rather than being tested.',
    whenUsed: 'When no existing theory adequately explains a process or phenomenon, and the goal is to build new theory.',
    evidenceStrength: 'Strong for theory development — generates frameworks that can later be tested quantitatively.',
  },
  {
    name: 'Case Study',
    category: 'qualitative',
